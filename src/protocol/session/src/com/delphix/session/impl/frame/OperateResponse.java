...
/**
 * This class serves as the base for all session responses except login.
 */
public abstract class OperateResponse extends ResponseFrame {

    protected boolean foreChannel = true;

    protected OperateResponse() {
        super();
    }
