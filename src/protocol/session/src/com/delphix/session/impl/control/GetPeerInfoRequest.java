...
public class GetPeerInfoRequest extends AbstractControlRequest {

    public GetPeerInfoRequest() {
        super(GetPeerInfoRequest.class.getSimpleName());
    }

    @Override
    public ServiceResponse execute(ServiceNexus nexus) {
        GetPeerInfoResponse response = new GetPeerInfoResponse();
        response.setInfo(nexus.getInfo());
        return response;
    }
}
