...
/**
 * The WriteDataRequest is a StreamDataRequest associated with a write file task.
 */
public class WriteDataRequest extends StreamDataRequest {

    public WriteDataRequest() {
        super(WriteDataRequest.class.getSimpleName());
    }

    @Override
    public ServiceResponse execute(ServiceNexus nexus) {
        return nexus.getProtocolHandler(RemoteProtocolServer.class).writeData(this, nexus);
    }
}
