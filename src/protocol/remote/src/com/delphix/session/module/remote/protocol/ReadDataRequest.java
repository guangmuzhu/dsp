...
/**
 * The ReadDataRequest is a StreamDataRequest associated with a read file task.
 */
public class ReadDataRequest extends StreamDataRequest {

    public ReadDataRequest() {
        super(ReadDataRequest.class.getSimpleName());
    }

    @Override
    public ServiceResponse execute(ServiceNexus nexus) {
        return nexus.getProtocolHandler(RemoteProtocolClient.class).readData(this, nexus);
    }
}
